...
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { S_IN }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
#set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { R }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { S_OUT }]; #IO_L16N_T2_A15_D31_14 Sch=led[8]
